...
def main(argv):
    ...
    #starting
    # dynamixel_obj0.set_goal_pos_callback(165) #motor 1 first
    # dynamixel_obj1.set_goal_pos_callback(315) #link 2
    # dynamixel_obj2.set_goal_pos_callback(300) #gripper
    ...
    # # arm up
    # dynamixel_obj0.set_goal_pos_callback(225) #motor 1 first
    # dynamixel_obj1.set_goal_pos_callback(275) #link 2
    # # dynamixel_obj2.set_goal_pos_callback(300) #gripper
