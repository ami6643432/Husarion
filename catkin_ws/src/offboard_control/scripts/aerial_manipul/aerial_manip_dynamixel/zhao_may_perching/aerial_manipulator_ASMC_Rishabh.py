...
class Controller:
    ...
    def __init__(self):
        ...
        self.Lam = np.array([2.2, 2.2, 3.6]) #Change 1
        self.Phi = np.array([1.3, 1.3, 1.1])
        
        self.M = 0.4 #Change 2
        self.alpha_0 = np.array([1,1,1])
        self.alpha_1 = np.array([3,3,3])
        self.alpha_m = 0.03 #Change 3
        self.v = 0.1  
...
def main(argv):
    ...
    dynamixel_obj0.set_goal_pos_callback(280) #motor 1 first
    dynamixel_obj1.set_goal_pos_callback(180) #Link2
    
    # dynamixel_obj3.set_goal_pos_callback(310) #gripper
