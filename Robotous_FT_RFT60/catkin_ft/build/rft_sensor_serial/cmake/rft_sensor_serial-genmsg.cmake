...
get_filename_component(_filename "/home/husarion/Robotous_FT_RFT60/catkin_ft/src/RFT_Sensor_Serial/srv/rft_operation.srv" NAME_WE)
add_custom_target(_rft_sensor_serial_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "rft_sensor_serial" "/home/husarion/Robotous_FT_RFT60/catkin_ft/src/RFT_Sensor_Serial/srv/rft_operation.srv" ""
)
...
_generate_srv_cpp(rft_sensor_serial
  "/home/husarion/Robotous_FT_RFT60/catkin_ft/src/RFT_Sensor_Serial/srv/rft_operation.srv"
  "${MSG_I_FLAGS}"
  ""
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rft_sensor_serial)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/rft_sensor_serial\")")
  # install generated code
  install(
